...
/**
 * Crawler Constructor:
 * Build a tree from a URL, exploring iteratively among childs and saving in MongoDB
 * @param url
 * @constructor
 */
class Crawler {
  ...
  /**
   * Generates array of nodes from array of DOM objects
   * @param urlraiz
   * @param links
   * @returns Array
   */
